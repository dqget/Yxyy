...
<body>
<h1>标题</h1><br><br><br>
<section><c:set var="rid" value="${param.rid }" />
	预定的房间编号是：${rid }&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="OrderManage.jsp">返回</a>
	<br />
	<br />
	<form action="OrderRoom_do.jsp" method="post">
		客户编号：<input type="text" name="cid"/><br /> 联系人：<input
			type="text" name="oname" /><br /> 联系电话：<input type="text"
			name="phone" /><br />开始时间：<input type="date"
			name="starttime" /><br />结束时间：<input type="date"
			name="endtime" /><br />
		<br /> <input type="hidden" name="rid" value="${rid }" /><br />
