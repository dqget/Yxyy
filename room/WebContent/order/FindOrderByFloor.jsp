...
<h1>标题</h1><br><br><br>
<section>
<form action="FindOrderByFloor.jsp" method="post">
<input name="floor" type="text"/>
<input type="submit" value="提交"/>
</form>
	<c:set var="floor" value="${param.floor }" />
	<jsp:useBean id="OrderBean" class="bean.OrderBean" />
	<c:set var="orders" value="${OrderBean.getOrderByFloor(floor) }"></c:set>
	<table>
