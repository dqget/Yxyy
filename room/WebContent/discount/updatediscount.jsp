...
<%
		...
		discountBean disb = (discountBean)request.getAttribute("disb");
		if(disb==null){
			return;
		}else{
	%>
		...
		<form action="updatediscount2" method="post">
			<table>
				<tr>
					<th>会员类型</th>
					<th>：</th>
					<th><%=disb.getMemberType() %></th>
				</tr>
				<tr>
					<th>原会员折扣</th>
					<th>：</th>
					<th><%=disb.getDiscount() %></th>
				</tr>
				<tr>
					<th>用户密码</th>
					<th>：</th>
					<th><input id="r2_input" name="discount" type="text"
						style="color: rgb(153, 153, 153);">
						<input id="r2_input" name="MemberType" type="hidden" value="<%=disb.getMemberType() %>"></th>
				</tr>
				<tr>
					<th></th>
					<th></th>
