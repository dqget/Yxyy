	...
	<div>
		<form action="../findroom" method="post">
			<tr>
				<th>楼层号</th>
				<th>：</th>
				<th><input id="r1_input" name="FloorNum" value="" type="text"
					style="color: rgb(153, 153, 153); "></th>
			</tr>
			<tr>
				<th>标准</th>
				<th>：</th>
				<th><input id="r2_input" name="RoomStandard" value="" type="text"
					style="color: rgb(153, 153, 153); "></th>
			</tr>
			<tr>
				<th></th>
				<th></th>
				<th><button value="查询">查询</th>
			</tr>
		</form>
	</div>
	<div>
		<table border="1">
			<%
				...
				List<roomBean> list = (List) session1.getAttribute("list");
			...
			%>
			<tr>
				<td><%=list.get(i).getRoomNum()%></td>
				<td><%=list.get(i).getFloorNum()%></td>
				<td><%=list.get(i).getRoomStandard()%></td>
				<td><%=list.get(i).getRoomCharge()%></td>
				<td><%=list.get(i).getRoomPosition()%></td>
				<td><%=list.get(i).getRoomStatus()%></td>
			</tr>
			<%
				}
				}
