...
<body>
	<%
		...
		roomBean rbn = (roomBean)request.getAttribute("rbn");
		if(rbn==null){
			return;
		}else{
	%>
	<h1>标题</h1><br><br><br>
	<div>
		<form action="updateroom2" method="post">
			<table>
				<tr>
					<th>原费用</th>
					<th>：</th>
					<th><%=rbn.getRoomCharge() %></th>
				</tr>
				<tr>
					<th>费用</th>
					<th>：</th>
					<th><input id="r1_input" name="RoomCharge" type="text"
						style="color: rgb(153, 153, 153);"></th>
				</tr>
				<tr>
					<th>原状态</th>
					<th>：</th>
					<th><%=rbn.getRoomStatus() %></th>
				</tr>
				<tr>
					<th>状态</th>
					<th>：</th>
					<th><input id="r2_input" name="RoomStatus" type="text"
						style="color: rgb(153, 153, 153);"></th>
				</tr>
				<tr>
					<th>更新时间</th>
					<th>：</th>
					<th><input id="r3_input" name="datetime" type="date"
						style="color: rgb(153, 153, 153);"> <input name="RoomNum"
						type="hidden" value=<%=rbn.getRoomNum() %>></th>
				</tr>
