		...
		<form action="../insertroom" method="post">
			<table>
				<tr>
					<th>楼层号</th>
			<!-- 		<th>：</th> -->
					<th><input id="r1_input" name="FloorNum" type="text"
						style="color: rgb(153, 153, 153);"></th>
				</tr>
				<tr>
					<th>房间号</th>
			<!-- 		<th>：</th> -->
					<th><input id="r2_input" name="RoomNum" type="text"
						style="color: rgb(153, 153, 153);"></th>
				</tr>
				<tr>
					<th>标准</th>
			<!-- 		<th>：</th> -->
					<th><input id="r3_input" name="RoomStandard" type="text"
						style="color: rgb(153, 153, 153);"></th>
				</tr>
				<tr>
					<th>费用</th>
			<!-- 		<th>：</th> -->
					<th><input id="r4_input" name="RoomCharge" type="text"
						style="color: rgb(153, 153, 153);"></th>
				</tr>
				<tr>
					<th>位置</th>
			<!-- 		<th>：</th> -->
					<th><input id="r5_input" name="RoomPosition" type="text"
						style="color: rgb(153, 153, 153);"></th>
				</tr>
				<tr>
<!-- 					<th></th>-->
