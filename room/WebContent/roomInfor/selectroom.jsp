...
<h1>标题</h1><br><br><br>
	<table border="1">
		...
		<%
			List<roomBean> list = (List) request.getAttribute("list");
			if(list == null){
				return;
			}else{
		...
		<tr>
			...
			<td><a href="updateroom?id=<%=list.get(i).getRoomNum()%>">修改</a>
			<td><a href="deleteroom?id=<%=list.get(i).getRoomNum()%>">删除</a>
		</tr>
		<%
				}
			}
