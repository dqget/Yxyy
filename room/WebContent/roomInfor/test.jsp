...
<body>
<h1>标题</h1><br><br><br>
<a href="<%=request.getContextPath()%>/roomInfor/insertroom.jsp">新建房间</a>
<a href="<%=request.getContextPath()%>/roomInfor/updateroom.jsp">修改房间信息</a>
<a href="<%=request.getContextPath()%>/roomInfor/deleteroom.jsp">删除指定房间</a>
<a href="<%=request.getContextPath()%>/roomInfor/selectroom.jsp">查询房间信息</a>
</body>
</html>