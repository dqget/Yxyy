	...
	<HEAD>
		...
		<script type="text/javascript">
			function returnTOfindAll(){
				window.location.href = "${pageContext.request.contextPath}/admin/adminProduct_findAll.action";
			}
		</script>
	</HEAD>
		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct_save.action" method="post"  enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="pnum" value="" id="userAction_save_do_logonName" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						销量：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="psales" value="" id="userAction_save_do_logonName" class="bg"/>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
