		...
		<form id="Form1" name="Form1" action="#" method="post">
			<table cellSpacing="1" cellPadding="0" width="100%" align="center" bgColor="#f5fafe" border="0">
				<TBODY>
					...
					<s:else>
				     	<!-- 首页 -->
				     	<a href="${pageContext.request.contextPath}/adminOrder_findOrderByPageState.action?page=1&state=<s:property value="orderState"/>" class="firstPage">   首页   </a>
						<!-- 上页 -->
						<a href="${pageContext.request.contextPath}/adminOrder_findOrderByPageState.action?page=<s:property value="pageBean.page-1"/>&state=<s:property value="orderState"/>" class="previousPage">   上一页   </a>
						<a href="${pageContext.request.contextPath}/adminOrder_findOrderByPageState.action?page=<s:property value="pageBean.page-1"/>&state=<s:property value="orderState"/>">   <s:property value="pageBean.page-1"/>   </a>
					</s:else>
					...
					<s:else>
						<a href="${pageContext.request.contextPath}/adminOrder_findOrderByPageState?page=<s:property value="pageBean.page+1"/>&state=<s:property value="orderState"/>">   <s:property value="pageBean.page+1"/>   </a>
						<!-- 下页 -->
						<a href="${pageContext.request.contextPath}/adminOrder_findOrderByPageState?page=<s:property value="pageBean.page+1"/>&state=<s:property value="orderState"/>" class="nextPage">   下一页   </a>
						<!-- 尾页 -->
						<a href="${pageContext.request.contextPath}/adminOrder_findOrderByPageState?page=<s:property value="pageBean.totalPage"/>&state=<s:property value="orderState"/>"  class="lastPage">   尾页   </a>
					</s:else>
				</TBODY>
			</table>
		</form>
