	...
	<div class="span5">
		<div class="logo">
			<a href="http://localhost:8080/mango/">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="挑Sell"/>
			</a>
		</div>
	</div>
	<div class="span9">
	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span24">
			<div class="step step1">
				...
				<div class="total">
					当前积分：<em id="promotion"><s:property value="#session.existUser.monetary"/></em>
					折扣优惠：<em id="promotion"><s:property value="#session.existUser.discount"/></em>
					商品原价: <strong id="effectivePrice">￥<s:property value="#session.cart.total"/>元</strong>
				</div>
				<div class="bottom">
					...
					<s:else>
						<a href="${pageContext.request.contextPath}/index.action">您还没有购物</a>
					</s:else>
				</div>
		</div>
	</div>
