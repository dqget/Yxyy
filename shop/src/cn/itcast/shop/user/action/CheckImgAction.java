...
public class CheckImgAction extends ActionSupport {
	...
	public String execute(){
		System.out.println("=========================进入checkImgAction");
		int width = 120;
		int height = 30;
		...
		String words = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz23456789";
		// String words =
		...
		System.out.println("session====checkcode"+ServletActionContext.getRequest().getSession()
